    ...
    <div class="coversation-toolbar">
        ...
        <div class="active-conversation">
            <div class="chat-avatar">
                <img src="<?php echo base_url();?>/assets/images/avatar/amarkdalen.jpg" alt="user">
            </div>
        ...
        <ul class="chat-user-list">
            <li>
                <div data-trigger="hover" title="Robertoortiz" data-content="<div class='chat-user-info'>
                                        ...
                                        <img src='<?php echo base_url();?>/assets/images/avatar/robertoortiz.jpg' alt='Avatar'>
                                        </div>
                                        ...
                                        " data-placement="left"><span class="chat-avatar"><img src="<?php echo base_url();?>/assets/images/avatar/robertoortiz.jpg" alt="Avatar"></span><span class="chat-u-info">Adellecharles<cite>New York</cite></span>
                </div>
            ...
            <li class="chat-u-online">
                <div data-trigger="hover" title="Kurafire" data-content="<div class='chat-user-info'>
                                        <div class='chat-user-avatar'>
                                        <img src='<?php echo base_url();?>/assets/images/avatar/kurafire.jpg' alt='Avatar'>
                                        </div>
                                        <div class='chat-user-details'>
                                        <ul>
                                        <li>Status: <span>Online</span></li>
                                        ...
                                        " data-placement="left"><span class="chat-avatar"><img src="<?php echo base_url();?>/assets/images/avatar/kurafire.jpg" alt="Avatar"></span><span class="chat-u-info">Kurafire<cite>New York</cite></span>
                </div>
                <span class="chat-u-status"><i class="fa fa-circle"></i></span>
            </li>
            <li class="chat-u-away">
                <div data-trigger="hover" title="Mikeluby" data-content="<div class='chat-user-info'>
                                        <div class='chat-user-avatar'>
                                        <img src='<?php echo base_url();?>/assets/images/avatar/mikeluby.jpg' alt='Avatar'>
                                        </div>
                                        <div class='chat-user-details'>
                                        <ul>
                                        <li>Status: <span>Online</span></li>
                                        ...
                                        " data-placement="left">
                    <span class="chat-avatar"><img src="<?php echo base_url();?>/assets/images/avatar/mikeluby.jpg" alt="Avatar"></span><span class="chat-u-info">Bobbyjkane<cite>London City</cite></span>
                </div>
                <span class="chat-u-status"><i class="fa fa-circle"></i></span>
            </li>
            <li class="chat-u-busy">
                <div data-trigger="hover" title="Joostvanderree" data-content="<div class='chat-user-info'>
                                        <div class='chat-user-avatar'>
                                        <img src='<?php echo base_url();?>/assets/images/avatar/joostvanderree.jpg' alt='Avatar'>
                                        </div>
                                        <div class='chat-user-details'>
                                        <ul>
                                        <li>Status: <span>Online</span></li>
                                        ...
                                        " data-placement="left">
                    <span class="chat-avatar"><img src="<?php echo base_url();?>/assets/images/avatar/joostvanderree.jpg" alt="Avatar"></span><span class="chat-u-info">Joostvanderree<cite>New York</cite></span>
                </div>
                <span class="chat-u-status"><i class="fa fa-circle"></i></span>
            </li>
        </ul>
        ...
        <ul class="chat-user-list">
            <li>
                <div data-trigger="hover" title="Kevinthompson" data-content="<div class='chat-user-info'>
                                        <div class='chat-user-avatar'>
                                        <img src='<?php echo base_url();?>/assets/images/avatar/Kevinthompson.html' alt='Avatar'>
                                        </div>
                                        <div class='chat-user-details'>
                                        <ul>
                                        <li>Status: <span>Online</span></li>
                                        ...
                                        " data-placement="left">
                    <span class="chat-avatar"><img src="<?php echo base_url();?>/assets/images/avatar/kevinthompson.jpg" alt="Avatar"></span><span class="chat-u-info">Kevinthompson<cite>Scotland</cite></span>
                </div>
                <span class="chat-u-status"><i class="fa fa-circle"></i></span>
            </li>
            <li class="chat-u-online">
                <div data-trigger="hover" title="Mds" data-content="<div class='chat-user-info'>
                                        <div class='chat-user-avatar'>
                                        <img src='<?php echo base_url();?>/assets/images/avatar/mds.jpg' alt='Avatar'>
                                        </div>
                                        <div class='chat-user-details'>
                                        <ul>
                                        <li>Status: <span>Online</span></li>
                                        ...
                                        " data-placement="left">
                    <span class="chat-avatar"><img src="<?php echo base_url();?>/assets/images/avatar/mds.jpg" alt="Avatar"></span><span class="chat-u-info">Mds<cite>South West, England</cite></span>
                </div>
                <span class="chat-u-status"><i class="fa fa-circle"></i></span>
            </li>
            <li>
                <div data-trigger="hover" title="Mko" data-content="<div class='chat-user-info'>
                                        <div class='chat-user-avatar'>
                                        <img src='<?php echo base_url();?>/assets/images/avatar/mko.jpg' alt='Avatar'>
                                        </div>
                                        <div class='chat-user-details'>
                                        <ul>
                                        <li>Status: <span>Online</span></li>
                                        ...
                                        " data-placement="left">
                    <span class="chat-avatar"><img src="<?php echo base_url();?>/assets/images/avatar/mko.jpg" alt="Avatar"></span><span class="chat-u-info">Mko<cite>New York</cite></span>
                </div>
                <span class="chat-u-status"><i class="fa fa-circle"></i></span>
            </li>
            <li>
                <div data-trigger="hover" title="Coreyweb" data-content="<div class='chat-user-info'>
                                        <div class='chat-user-avatar'>
                                        <img src='<?php echo base_url();?>/assets/images/avatar/coreyweb.jpg' alt='Avatar'>
                                        </div>
                                        <div class='chat-user-details'>
                                        <ul>
                                        <li>Status: <span>Online</span></li>
                                        ...
                                        " data-placement="left">
                    <span class="chat-avatar"><img src="<?php echo base_url();?>/assets/images/avatar/coreyweb.jpg" alt="Avatar"></span><span class="chat-u-info">Coreyweb<cite>Northern Ireland</cite></span>
                </div>
                <span class="chat-u-status"><i class="fa fa-circle"></i></span>
            </li>
            <li>
                <div data-trigger="hover" title="Amarkdalen" data-content="<div class='chat-user-info'>
                                        <div class='chat-user-avatar'>
                                        <img src='<?php echo base_url();?>/assets/images/avatar/amarkdalen.jpg' alt='Avatar'>
                                        </div>
                                        <div class='chat-user-details'>
                                        <ul>
                                        <li>Status: <span>Online</span></li>
                                        ...
                                        " data-placement="left">
                    <span class="chat-avatar"><img src="<?php echo base_url();?>/assets/images/avatar/amarkdalen.jpg" alt="Avatar"></span><span class="chat-u-info">Oykun<cite>New York</cite></span>
                </div>
                <span class="chat-u-status"><i class="fa fa-circle"></i></span>
            </li>
        </ul>
                ...
                <div class="activities-details">
                    ...
                    <div class="activities-post">
                        <ul class="new-image-lists">
                            <li><a href="#"><img src="<?php echo base_url();?>/assets/images/img-1-thumb.jpg" alt="image"></a></li>
                            <li><a href="#"><img src="<?php echo base_url();?>/assets/images/img-2-thumb.jpg" alt="image"></a></li>
                            <li><a href="#"><img src="<?php echo base_url();?>/assets/images/img-3-thumb.jpg" alt="image"></a></li>
                ...
                <div class="activities-details">
                    ...
                    <div class="activities-post">
                        <ul class="new-user-lists">
                            <li><a href="#"><img src="<?php echo base_url();?>/assets/images/avatar/oykun.jpg" alt="image"></a></li>
                            <li><a href="#"><img src="<?php echo base_url();?>/assets/images/avatar/mds.jpg" alt="image"></a></li>
                            <li><a href="#"><img src="<?php echo base_url();?>/assets/images/avatar/robertoortiz.jpg" alt="image"></a></li>
                            <li><a href="#" class="more-list"><i class="zmdi zmdi-more-horiz"></i></a></li>
                        </ul>
                    </div>
                </div>
